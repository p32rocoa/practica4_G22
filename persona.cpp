...
//Getters
inline std::string Persona::getDNI() {return dni_;}
inline std::string Persona::getNombre() {return nombre_;}
inline std::string Persona::getApellidos() {return apellidos_;}
